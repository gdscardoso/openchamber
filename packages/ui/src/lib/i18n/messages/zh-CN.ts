...
export const dict: Record<I18nKey, string> = {
  ...
  'session.azureDevOpsIssuePicker.error.noActiveProject': '没有活动项目',
  'session.azureDevOpsIssuePicker.error.runtimeUnavailable': 'Azure DevOps 运行时 API 不可用',
  'session.azureDevOpsIssuePicker.error.notConnected': 'Azure DevOps 未连接',
  'session.azureDevOpsIssuePicker.error.repoNotResolvable': '无法解析仓库',
  'session.azureDevOpsIssuePicker.error.repoMustMatchProvider': 'origin 远程仓库必须是 Azure DevOps URL',
  'session.azureDevOpsIssuePicker.error.issueNotFound': '未找到工作项',
  'session.azureDevOpsIssuePicker.error.noModelSelected': '未选择模型',
  'session.azureDevOpsIssuePicker.toast.loadMoreFailed': '加载更多工作项失败',
  'session.azureDevOpsIssuePicker.toast.loadIssueDetailsFailed': '加载工作项详情失败',
  'session.azureDevOpsIssuePicker.toast.sendContextFailed': '发送工作项上下文失败',
  'session.azureDevOpsIssuePicker.toast.sessionCreated': '已从工作项创建会话',
  'session.azureDevOpsIssuePicker.toast.startSessionFailed': '启动会话失败',
  'session.azureDevOpsIssuePicker.title.select': '关联 Azure DevOps 工作项',
  'session.azureDevOpsIssuePicker.title.createSession': '从 Azure DevOps 工作项新建会话',
  'session.azureDevOpsIssuePicker.description.select': '选择一个工作项关联到当前会话。',
  'session.azureDevOpsIssuePicker.description.createSession': '使用隐藏的工作项上下文（标题/正文/标签/评论）初始化新会话。',
  'session.azureDevOpsIssuePicker.searchPlaceholder': '按标题或 #123 搜索，或粘贴工作项 URL',
  'session.azureDevOpsIssuePicker.empty.noActiveProject': '未选择活动项目。',
  'session.azureDevOpsIssuePicker.empty.runtimeUnavailable': 'Azure DevOps 运行时 API 不可用。',
  'session.azureDevOpsIssuePicker.empty.notConnected': 'Azure DevOps 未连接。请在设置中连接 Azure DevOps 账号。',
  'session.azureDevOpsIssuePicker.empty.noIssuesFound': '未找到工作项',
  'session.azureDevOpsIssuePicker.empty.noOpenIssuesFound': '没有未关闭的工作项',
  'session.azureDevOpsIssuePicker.loading.issues': '正在加载工作项...',
  'session.azureDevOpsIssuePicker.loading.more': '加载中...',
  'session.azureDevOpsIssuePicker.actions.openSettings': '打开设置',
  'session.azureDevOpsIssuePicker.actions.useIssue': '使用工作项 #{number}',
  'session.azureDevOpsIssuePicker.actions.openInProviderAria': '在 Azure DevOps 中打开',
  'session.azureDevOpsIssuePicker.actions.loadMore': '加载更多',
  'session.azureDevOpsIssuePicker.actions.sectionTitle': '操作',
  'session.azureDevOpsIssuePicker.actions.toggleWorktreeAria': '切换工作树',
  'session.azureDevOpsIssuePicker.actions.createInWorktree': '在工作树中创建',
  'session.azureDevOpsIssuePicker.actions.openRepo': '打开仓库',
  'session.azureDevOpsIssuePicker.actions.refresh': '刷新',
  ...
  'session.azureDevOpsPrPicker.error.noActiveProject': '没有活动项目',
  'session.azureDevOpsPrPicker.error.runtimeUnavailable': 'Azure DevOps 运行时 API 不可用',
  'session.azureDevOpsPrPicker.error.notConnected': 'Azure DevOps 未连接',
  'session.azureDevOpsPrPicker.error.prNotFound': '未找到 Pull Request',
  'session.azureDevOpsPrPicker.error.repoNotResolvable': '无法解析仓库',
  'session.azureDevOpsPrPicker.error.repoMustMatchProvider': 'origin 远程仓库必须是 Azure DevOps URL',
  'session.azureDevOpsPrPicker.toast.loadMoreFailed': '加载更多 Pull Request 失败',
  'session.azureDevOpsPrPicker.toast.loadDetailsFailed': '加载 Pull Request 详情失败',
  'session.azureDevOpsPrPicker.title': '关联 Azure DevOps Pull Request',
  'session.azureDevOpsPrPicker.description': '选择一个 pull request，将评审上下文附加到此消息。',
  'session.azureDevOpsPrPicker.searchPlaceholder': '按标题或 #123 搜索，或粘贴 pull request URL',
  'session.azureDevOpsPrPicker.includeDiffAria': '在附加上下文中包含 PR diff',
  'session.azureDevOpsPrPicker.includeDiff': '包含 PR diff',
  'session.azureDevOpsPrPicker.empty.noActiveProject': '未选择活动项目。',
  'session.azureDevOpsPrPicker.empty.runtimeUnavailable': 'Azure DevOps 运行时 API 不可用。',
  'session.azureDevOpsPrPicker.empty.notConnected': 'Azure DevOps 未连接。请在设置中连接你的 Azure DevOps 账户。',
  'session.azureDevOpsPrPicker.empty.noPullRequestsFound': '未找到 Pull Request',
  'session.azureDevOpsPrPicker.empty.noOpenPullRequestsFound': '未找到打开的 Pull Request',
  'session.azureDevOpsPrPicker.loading.pullRequests': '正在加载 Pull Request...',
  'session.azureDevOpsPrPicker.loading.more': '加载中...',
  'session.azureDevOpsPrPicker.actions.openSettings': '打开设置',
  'session.azureDevOpsPrPicker.actions.usePullRequest': '使用 Pull Request #{number}',
  'session.azureDevOpsPrPicker.actions.openInProviderAria': '在 Azure DevOps 中打开',
  'session.azureDevOpsPrPicker.actions.loadMore': '加载更多',
  ...
  'chat.chatInput.actions.linkIssue': '关联 Issue / 工作项',
  'chat.chatInput.actions.linkPr': '关联 Pull Request',
  ...
  'memoryDebugPanel.metric.githubTotalRequests': 'PR 状态请求总数',
