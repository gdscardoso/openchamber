...
export const dict: Record<I18nKey, string> = {
  ...
  "session.azureDevOpsIssuePicker.error.noActiveProject": "Немає активного проєкту",
  "session.azureDevOpsIssuePicker.error.runtimeUnavailable": "Azure DevOps API недоступний",
  "session.azureDevOpsIssuePicker.error.notConnected": "Azure DevOps не підключено",
  "session.azureDevOpsIssuePicker.error.repoNotResolvable": "Не вдалося визначити репозиторій",
  "session.azureDevOpsIssuePicker.error.repoMustMatchProvider": "remote origin має бути URL Azure DevOps",
  "session.azureDevOpsIssuePicker.error.issueNotFound": "Робочий елемент не знайдено",
  "session.azureDevOpsIssuePicker.error.noModelSelected": "Модель не вибрано",
  "session.azureDevOpsIssuePicker.toast.loadMoreFailed": "Не вдалося завантажити більше робочих елементів",
  "session.azureDevOpsIssuePicker.toast.loadIssueDetailsFailed": "Не вдалося завантажити деталі робочого елемента",
  "session.azureDevOpsIssuePicker.toast.sendContextFailed": "Не вдалося надіслати контекст робочого елемента",
  "session.azureDevOpsIssuePicker.toast.sessionCreated": "Сесію створено з робочого елемента",
  "session.azureDevOpsIssuePicker.toast.startSessionFailed": "Не вдалося запустити сесію",
  "session.azureDevOpsIssuePicker.title.select": "Пов'язати робочий елемент Azure DevOps",
  "session.azureDevOpsIssuePicker.title.createSession": "Нова сесія з робочого елемента Azure DevOps",
  "session.azureDevOpsIssuePicker.description.select": "Виберіть робочий елемент, який потрібно пов'язати з цією сесією.",
  "session.azureDevOpsIssuePicker.description.createSession": "Створює нову сесію з прихованим контекстом робочого елемента (заголовок/текст/мітки/коментарі).",
  "session.azureDevOpsIssuePicker.searchPlaceholder": "Шукайте за назвою або #123, або вставте URL робочого елемента",
  "session.azureDevOpsIssuePicker.empty.noActiveProject": "Активний проєкт не вибрано.",
  "session.azureDevOpsIssuePicker.empty.runtimeUnavailable": "Azure DevOps API недоступний.",
  "session.azureDevOpsIssuePicker.empty.notConnected": "Azure DevOps не підключено. Підключіть обліковий запис Azure DevOps у налаштуваннях.",
  "session.azureDevOpsIssuePicker.empty.noIssuesFound": "Робочих елементів не знайдено",
  "session.azureDevOpsIssuePicker.empty.noOpenIssuesFound": "Відкритих робочих елементів не знайдено",
  "session.azureDevOpsIssuePicker.loading.issues": "Завантаження робочих елементів...",
  "session.azureDevOpsIssuePicker.loading.more": "Завантаження...",
  "session.azureDevOpsIssuePicker.actions.openSettings": "Відкрити налаштування",
  "session.azureDevOpsIssuePicker.actions.useIssue": "Використати робочий елемент #{number}",
  "session.azureDevOpsIssuePicker.actions.openInProviderAria": "Відкрити в Azure DevOps",
  "session.azureDevOpsIssuePicker.actions.loadMore": "Завантажити ще",
  "session.azureDevOpsIssuePicker.actions.sectionTitle": "Дії",
  "session.azureDevOpsIssuePicker.actions.toggleWorktreeAria": "Перемкнути worktree",
  "session.azureDevOpsIssuePicker.actions.createInWorktree": "Створити в worktree",
  "session.azureDevOpsIssuePicker.actions.openRepo": "Відкрити репозиторій",
  "session.azureDevOpsIssuePicker.actions.refresh": "Оновити",
  ...
  "session.azureDevOpsPrPicker.error.noActiveProject": "Немає активного проєкту",
  "session.azureDevOpsPrPicker.error.runtimeUnavailable": "Runtime API Azure DevOps недоступний",
  "session.azureDevOpsPrPicker.error.notConnected": "Azure DevOps не підключено",
  "session.azureDevOpsPrPicker.error.prNotFound": "Pull request не знайдено",
  "session.azureDevOpsPrPicker.error.repoNotResolvable": "Репозиторій неможливо визначити",
  "session.azureDevOpsPrPicker.error.repoMustMatchProvider": "remote origin має бути URL Azure DevOps",
  "session.azureDevOpsPrPicker.toast.loadMoreFailed": "Не вдалося завантажити більше pull request",
  "session.azureDevOpsPrPicker.toast.loadDetailsFailed": "Не вдалося завантажити деталі pull request",
  "session.azureDevOpsPrPicker.title": "Пов'язати pull request Azure DevOps",
  "session.azureDevOpsPrPicker.description": "Виберіть pull request, щоб додати контекст рев'ю до цього повідомлення.",
  "session.azureDevOpsPrPicker.searchPlaceholder": "Пошук за назвою або #123, або вставте URL pull request",
  "session.azureDevOpsPrPicker.includeDiffAria": "Додати diff PR до прикріпленого контексту",
  "session.azureDevOpsPrPicker.includeDiff": "Додати diff PR",
  "session.azureDevOpsPrPicker.empty.noActiveProject": "Немає вибраного активного проєкту.",
  "session.azureDevOpsPrPicker.empty.runtimeUnavailable": "Runtime API Azure DevOps недоступний.",
  "session.azureDevOpsPrPicker.empty.notConnected": "Azure DevOps не підключено. Підключіть обліковий запис Azure DevOps у налаштуваннях.",
  "session.azureDevOpsPrPicker.empty.noPullRequestsFound": "Pull request не знайдено",
  "session.azureDevOpsPrPicker.empty.noOpenPullRequestsFound": "Відкритих pull request не знайдено",
  "session.azureDevOpsPrPicker.loading.pullRequests": "Завантаження pull request...",
  "session.azureDevOpsPrPicker.loading.more": "Завантаження...",
  "session.azureDevOpsPrPicker.actions.openSettings": "Відкрити налаштування",
  "session.azureDevOpsPrPicker.actions.usePullRequest": "Використати pull request #{number}",
  "session.azureDevOpsPrPicker.actions.openInProviderAria": "Відкрити в Azure DevOps",
  "session.azureDevOpsPrPicker.actions.loadMore": "Завантажити ще",
  ...
  "chat.chatInput.actions.linkIssue": "Пов’язати issue / work item",
  "chat.chatInput.actions.linkPr": "Пов’язати pull request",
  ...
  "memoryDebugPanel.metric.githubTotalRequests": "Загальна кількість запитів статусу PR",
