...
export const dict: Record<I18nKey, string> = {
  ...
  "gitView.pr.actions.openRepo": "Open repository",
  ...
  "session.azureDevOpsIssuePicker.error.noActiveProject": "No hay ningún proyecto activo",
  "session.azureDevOpsIssuePicker.error.runtimeUnavailable": "API de runtime de Azure DevOps no disponible",
  "session.azureDevOpsIssuePicker.error.notConnected": "Azure DevOps no está conectado",
  "session.azureDevOpsIssuePicker.error.repoNotResolvable": "No se pudo resolver el repositorio",
  "session.azureDevOpsIssuePicker.error.repoMustMatchProvider": "El remoto origin debe ser una URL de Azure DevOps",
  "session.azureDevOpsIssuePicker.error.issueNotFound": "No se encontró el work item",
  "session.azureDevOpsIssuePicker.error.noModelSelected": "No hay ningún modelo seleccionado",
  "session.azureDevOpsIssuePicker.toast.loadMoreFailed": "No se pudieron cargar más work items",
  "session.azureDevOpsIssuePicker.toast.loadIssueDetailsFailed": "No se pudieron cargar los detalles del work item",
  "session.azureDevOpsIssuePicker.toast.sendContextFailed": "No se pudo enviar el contexto del work item",
  "session.azureDevOpsIssuePicker.toast.sessionCreated": "Sesión creada a partir del work item",
  "session.azureDevOpsIssuePicker.toast.startSessionFailed": "No se pudo iniciar la sesión",
  "session.azureDevOpsIssuePicker.title.select": "Vincular work item de Azure DevOps",
  "session.azureDevOpsIssuePicker.title.createSession": "Nueva sesión de work item de Azure DevOps",
  "session.azureDevOpsIssuePicker.description.select": "Selecciona un work item para vincularlo a esta sesión.",
  "session.azureDevOpsIssuePicker.description.createSession": "Inicia una nueva sesión con contexto oculto del work item (título/cuerpo/etiquetas/comentarios).",
  "session.azureDevOpsIssuePicker.searchPlaceholder": "Buscar por título o #123, o pegar la URL del work item",
  "session.azureDevOpsIssuePicker.empty.noActiveProject": "No hay ningún proyecto activo seleccionado.",
  "session.azureDevOpsIssuePicker.empty.runtimeUnavailable": "API de runtime de Azure DevOps no disponible.",
  "session.azureDevOpsIssuePicker.empty.notConnected": "Azure DevOps no está conectado. Conecta tu cuenta de Azure DevOps en la configuración.",
  "session.azureDevOpsIssuePicker.empty.noIssuesFound": "No se encontraron work items",
  "session.azureDevOpsIssuePicker.empty.noOpenIssuesFound": "No se encontraron work items abiertos",
  "session.azureDevOpsIssuePicker.loading.issues": "Cargando work items...",
  "session.azureDevOpsIssuePicker.loading.more": "Cargando...",
  "session.azureDevOpsIssuePicker.actions.openSettings": "Abrir configuración",
  "session.azureDevOpsIssuePicker.actions.useIssue": "Usar work item #{number}",
  "session.azureDevOpsIssuePicker.actions.openInProviderAria": "Abrir en Azure DevOps",
  "session.azureDevOpsIssuePicker.actions.loadMore": "Cargar más",
  "session.azureDevOpsIssuePicker.actions.sectionTitle": "Acciones",
  "session.azureDevOpsIssuePicker.actions.toggleWorktreeAria": "Activar worktree",
  "session.azureDevOpsIssuePicker.actions.createInWorktree": "Crear en worktree",
  "session.azureDevOpsIssuePicker.actions.openRepo": "Abrir repositorio",
  "session.azureDevOpsIssuePicker.actions.refresh": "Actualizar",
  ...
  "session.azureDevOpsPrPicker.error.noActiveProject": "No hay proyecto activo",
  "session.azureDevOpsPrPicker.error.runtimeUnavailable": "La API de runtime de Azure DevOps no está disponible",
  "session.azureDevOpsPrPicker.error.notConnected": "Azure DevOps no está conectado",
  "session.azureDevOpsPrPicker.error.prNotFound": "Pull request no encontrado",
  "session.azureDevOpsPrPicker.error.repoNotResolvable": "Repositorio no resoluble",
  "session.azureDevOpsPrPicker.error.repoMustMatchProvider": "el remote origin debe ser una URL de Azure DevOps",
  "session.azureDevOpsPrPicker.toast.loadMoreFailed": "No se pudieron cargar más pull requests",
  "session.azureDevOpsPrPicker.toast.loadDetailsFailed": "No se pudieron cargar los detalles del pull request",
  "session.azureDevOpsPrPicker.title": "Vincular pull request de Azure DevOps",
  "session.azureDevOpsPrPicker.description": "Selecciona un pull request para adjuntar el contexto de revisión a este mensaje.",
  "session.azureDevOpsPrPicker.searchPlaceholder": "Busca por título o #123, o pega la URL del pull request",
  "session.azureDevOpsPrPicker.includeDiffAria": "Incluir diff del PR en el contexto adjunto",
  "session.azureDevOpsPrPicker.includeDiff": "Incluir diff del PR",
  "session.azureDevOpsPrPicker.empty.noActiveProject": "No hay un proyecto activo seleccionado.",
  "session.azureDevOpsPrPicker.empty.runtimeUnavailable": "La API de runtime de Azure DevOps no está disponible.",
  "session.azureDevOpsPrPicker.empty.notConnected": "Azure DevOps no está conectado. Conecta tu cuenta de Azure DevOps en configuración.",
  "session.azureDevOpsPrPicker.empty.noPullRequestsFound": "No se encontraron pull requests",
  "session.azureDevOpsPrPicker.empty.noOpenPullRequestsFound": "No se encontraron pull requests abiertos",
  "session.azureDevOpsPrPicker.loading.pullRequests": "Cargando pull requests...",
  "session.azureDevOpsPrPicker.loading.more": "Cargando...",
  "session.azureDevOpsPrPicker.actions.openSettings": "Abrir configuración",
  "session.azureDevOpsPrPicker.actions.usePullRequest": "Usar pull request #{number}",
  "session.azureDevOpsPrPicker.actions.openInProviderAria": "Abrir en Azure DevOps",
  "session.azureDevOpsPrPicker.actions.loadMore": "Cargar más",
  ...
  "memoryDebugPanel.metric.githubTotalRequests": "Solicitudes totales de estado de PR",
  ...
  "settings.workspaces.description": "Manage task workspaces and project membership.",
  "settings.workspaces.newPlaceholder": "New workspace",
  "settings.workspaces.empty": "No workspace selected.",
  "settings.workspaces.deleteConfirm": "Delete workspace {name}? Its projects move back to Default.",
  "settings.workspaces.action.save": "Save",
  "settings.workspaces.action.delete": "Delete",
  "settings.workspaces.projects.title": "Projects",
  "settings.workspaces.projects.empty": "No projects configured.",
  "settings.workspaces.toast.created": "Workspace created",
  "settings.workspaces.toast.createFailed": "Failed to create workspace",
  "settings.workspaces.toast.saved": "Workspace saved",
  "settings.workspaces.toast.saveFailed": "Failed to save workspace",
  "settings.workspaces.toast.deleted": "Workspace deleted",
  "settings.workspaces.toast.deleteFailed": "Failed to delete workspace",
  "tasks.header.workspace": "Workspace",
  "tasks.header.projectFilter": "Project filter",
  "tasks.header.projectFilterAll": "All projects",
  "tasks.header.newTask": "New task",
  "tasks.header.kanban": "Kanban",
  "tasks.header.daily": "Daily",
  "tasks.workspace.new": "New workspace",
  "tasks.workspace.promptName": "Workspace name",
  "tasks.empty.noWorkspaces": "No workspaces yet",
  "tasks.empty.noTasks": "Create a workspace and your first task",
  "tasks.empty.column": "No tasks here",
  "tasks.empty.noDaily": "No task activity on this day",
  "tasks.error.load": "Failed to load tasks",
  "tasks.error.retry": "Retry",
  "tasks.modal.createTitle": "Create task",
  "tasks.modal.editTitle": "Edit task",
  "tasks.modal.deleteConfirm": "Delete this task?",
  "tasks.modal.field.title": "Title",
  "tasks.modal.field.project": "Project",
  "tasks.modal.field.status": "Status",
  "tasks.modal.field.branch": "Branch",
  "tasks.modal.field.session": "Session link",
  "tasks.modal.field.tags": "Tags",
  "tasks.modal.field.tagsPlaceholder": "bug, api",
  "tasks.modal.field.content": "Content",
  "tasks.modal.field.preview": "Preview",
  "tasks.modal.contentPlaceholder": "Type your description here...",
  "tasks.modal.branch.loading": "Loading branches...",
  "tasks.modal.branch.noProject": "Choose project first",
  "tasks.modal.action.delete": "Delete",
  "tasks.modal.action.cancel": "Cancel",
  "tasks.modal.action.save": "Save",
  "tasks.modal.action.create": "Create",
  "tasks.modal.action.checkoutBranch": "Checkout",
  "tasks.modal.createMore": "Create more",
  "tasks.modal.action.openSession": "Open",
  "tasks.modal.toast.checkoutSuccess": "Checked out {branch}",
  "tasks.modal.toast.checkoutFailed": "Failed to checkout branch",
  "tasks.modal.timestamp.created": "Created {date}",
  "tasks.modal.timestamp.started": "Started {date}",
  "tasks.modal.timestamp.completed": "Completed {date}",
  "tasks.status.todo": "Todo",
  "tasks.status.in_progress": "In progress",
  "tasks.status.done": "Done",
  "tasks.daily.previousDay": "Previous day",
  "tasks.daily.today": "Today",
  "tasks.daily.nextDay": "Next day",
  "tasks.daily.datePicker": "Choose day",
  "tasks.daily.doing": "In progress",
  "tasks.daily.done": "Completed on day",
};
