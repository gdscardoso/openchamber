...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.chatInput.actions.linkIssue': 'Link Issue / Work Item',
  'chat.chatInput.actions.linkPr': 'Link Pull Request',
  ...
  'memoryDebugPanel.metric.githubTotalRequests': 'Łączna liczba żądań statusu PR',
  ...
  'session.azureDevOpsIssuePicker.error.noActiveProject': 'Brak aktywnego projektu',
  'session.azureDevOpsIssuePicker.error.runtimeUnavailable': 'API środowiska Azure DevOps jest niedostępne',
  'session.azureDevOpsIssuePicker.error.notConnected': 'Azure DevOps nie jest połączony',
  'session.azureDevOpsIssuePicker.error.repoNotResolvable': 'Nie udało się rozpoznać repozytorium',
  'session.azureDevOpsIssuePicker.error.repoMustMatchProvider': 'remote origin musi być adresem URL Azure DevOps',
  'session.azureDevOpsIssuePicker.error.issueNotFound': 'Nie znaleziono elementu roboczego',
  'session.azureDevOpsIssuePicker.error.noModelSelected': 'Nie wybrano modelu',
  'session.azureDevOpsIssuePicker.toast.loadMoreFailed': 'Nie udało się załadować kolejnych elementów roboczych',
  'session.azureDevOpsIssuePicker.toast.loadIssueDetailsFailed': 'Nie udało się załadować szczegółów elementu roboczego',
  'session.azureDevOpsIssuePicker.toast.sendContextFailed': 'Nie udało się wysłać kontekstu elementu roboczego',
  'session.azureDevOpsIssuePicker.toast.sessionCreated': 'Sesja utworzona z elementu roboczego',
  'session.azureDevOpsIssuePicker.toast.startSessionFailed': 'Nie udało się uruchomić sesji',
  'session.azureDevOpsIssuePicker.title.select': 'Połącz element roboczy Azure DevOps',
  'session.azureDevOpsIssuePicker.title.createSession': 'Nowa sesja z elementu roboczego Azure DevOps',
  'session.azureDevOpsIssuePicker.description.select': 'Wybierz element roboczy, który chcesz powiązać z tą sesją.',
  'session.azureDevOpsIssuePicker.description.createSession': 'Tworzy nową sesję z ukrytym kontekstem elementu roboczego (tytuł/treść/etykiety/komentarze).',
  'session.azureDevOpsIssuePicker.searchPlaceholder': 'Szukaj po tytule lub #123, albo wklej URL elementu roboczego',
  'session.azureDevOpsIssuePicker.empty.noActiveProject': 'Nie wybrano aktywnego projektu.',
  'session.azureDevOpsIssuePicker.empty.runtimeUnavailable': 'API środowiska Azure DevOps jest niedostępne.',
  'session.azureDevOpsIssuePicker.empty.notConnected': 'Azure DevOps nie jest połączony. Połącz konto Azure DevOps w ustawieniach.',
  'session.azureDevOpsIssuePicker.empty.noIssuesFound': 'Nie znaleziono elementów roboczych',
  'session.azureDevOpsIssuePicker.empty.noOpenIssuesFound': 'Nie znaleziono otwartych elementów roboczych',
  'session.azureDevOpsIssuePicker.loading.issues': 'Ładowanie elementów roboczych...',
  'session.azureDevOpsIssuePicker.loading.more': 'Ładowanie...',
  'session.azureDevOpsIssuePicker.actions.openSettings': 'Otwórz ustawienia',
  'session.azureDevOpsIssuePicker.actions.useIssue': 'Użyj elementu roboczego #{number}',
  'session.azureDevOpsIssuePicker.actions.openInProviderAria': 'Otwórz w Azure DevOps',
  'session.azureDevOpsIssuePicker.actions.loadMore': 'Załaduj więcej',
  'session.azureDevOpsIssuePicker.actions.sectionTitle': 'Akcje',
  'session.azureDevOpsIssuePicker.actions.toggleWorktreeAria': 'Przełącz drzewo pracy',
  'session.azureDevOpsIssuePicker.actions.createInWorktree': 'Utwórz w drzewie pracy',
  'session.azureDevOpsIssuePicker.actions.openRepo': 'Otwórz repozytorium',
  'session.azureDevOpsIssuePicker.actions.refresh': 'Odśwież',
  ...
  'session.azureDevOpsPrPicker.error.noActiveProject': 'Brak aktywnego projektu',
  'session.azureDevOpsPrPicker.error.notConnected': 'Azure DevOps nie jest połączony',
  'session.azureDevOpsPrPicker.error.prNotFound': 'Nie znaleziono pull requesta',
  'session.azureDevOpsPrPicker.error.repoMustMatchProvider': 'remote origin musi być adresem URL Azure DevOps',
  'session.azureDevOpsPrPicker.error.repoNotResolvable': 'Nie udało się rozpoznać repozytorium',
  'session.azureDevOpsPrPicker.error.runtimeUnavailable': 'API środowiska Azure DevOps jest niedostępne',
  'session.azureDevOpsPrPicker.includeDiff': 'Dołącz diff PR',
  'session.azureDevOpsPrPicker.includeDiffAria': 'Dołącz diff PR do załączonego kontekstu',
  'session.azureDevOpsPrPicker.loading.more': 'Ładowanie...',
  'session.azureDevOpsPrPicker.loading.pullRequests': 'Ładowanie pull requestów...',
  'session.azureDevOpsPrPicker.searchPlaceholder': 'Szukaj po tytule lub #123, albo wklej URL pull requesta',
  'session.azureDevOpsPrPicker.title': 'Połącz pull request Azure DevOps',
  'session.azureDevOpsPrPicker.description': 'Wybierz pull request, aby dołączyć kontekst przeglądu do tej wiadomości.',
  'session.azureDevOpsPrPicker.toast.loadDetailsFailed': 'Nie udało się załadować szczegółów pull requesta',
  'session.azureDevOpsPrPicker.toast.loadMoreFailed': 'Nie udało się załadować kolejnych pull requestów',
  'session.azureDevOpsPrPicker.empty.noActiveProject': 'Nie wybrano aktywnego projektu.',
  'session.azureDevOpsPrPicker.empty.runtimeUnavailable': 'API środowiska Azure DevOps jest niedostępne.',
  'session.azureDevOpsPrPicker.empty.notConnected': 'Azure DevOps nie jest połączony. Połącz konto Azure DevOps w ustawieniach.',
  'session.azureDevOpsPrPicker.empty.noPullRequestsFound': 'Nie znaleziono pull requestów',
  'session.azureDevOpsPrPicker.empty.noOpenPullRequestsFound': 'Nie znaleziono otwartych pull requestów',
  'session.azureDevOpsPrPicker.actions.openSettings': 'Otwórz ustawienia',
  'session.azureDevOpsPrPicker.actions.usePullRequest': 'Użyj pull requesta #{number}',
  'session.azureDevOpsPrPicker.actions.openInProviderAria': 'Otwórz w Azure DevOps',
  'session.azureDevOpsPrPicker.actions.loadMore': 'Załaduj więcej',
