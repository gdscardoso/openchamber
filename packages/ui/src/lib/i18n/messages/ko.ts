...
export const dict: Record<I18nKey, string> = {
  ...
  'session.azureDevOpsIssuePicker.error.noActiveProject': '활성 프로젝트가 없습니다',
  'session.azureDevOpsIssuePicker.error.runtimeUnavailable': 'Azure DevOps 런타임 API를 사용할 수 없습니다',
  'session.azureDevOpsIssuePicker.error.notConnected': 'Azure DevOps에 연결되어 있지 않습니다',
  'session.azureDevOpsIssuePicker.error.repoNotResolvable': '저장소를 확인할 수 없습니다',
  'session.azureDevOpsIssuePicker.error.repoMustMatchProvider': 'origin 리모트는 Azure DevOps URL이어야 합니다',
  'session.azureDevOpsIssuePicker.error.issueNotFound': '작업 항목을 찾을 수 없습니다',
  'session.azureDevOpsIssuePicker.error.noModelSelected': '선택된 모델이 없습니다',
  'session.azureDevOpsIssuePicker.toast.loadMoreFailed': '작업 항목을 더 불러오지 못했습니다',
  'session.azureDevOpsIssuePicker.toast.loadIssueDetailsFailed': '작업 항목 세부 정보를 불러오지 못했습니다',
  'session.azureDevOpsIssuePicker.toast.sendContextFailed': '작업 항목 컨텍스트를 보내지 못했습니다',
  'session.azureDevOpsIssuePicker.toast.sessionCreated': '작업 항목에서 세션을 만들었습니다',
  'session.azureDevOpsIssuePicker.toast.startSessionFailed': '세션을 시작하지 못했습니다',
  'session.azureDevOpsIssuePicker.title.select': 'Azure DevOps 작업 항목 연결',
  'session.azureDevOpsIssuePicker.title.createSession': 'Azure DevOps 작업 항목에서 새 세션 만들기',
  'session.azureDevOpsIssuePicker.description.select': '이 세션에 연결할 작업 항목을 선택하세요.',
  'session.azureDevOpsIssuePicker.description.createSession': '숨겨진 작업 항목 컨텍스트(제목/본문/레이블/댓글)로 새 세션을 시작합니다.',
  'session.azureDevOpsIssuePicker.searchPlaceholder': '제목 또는 #123으로 검색하거나 작업 항목 URL을 붙여넣으세요',
  'session.azureDevOpsIssuePicker.empty.noActiveProject': '활성 프로젝트가 선택되지 않았습니다.',
  'session.azureDevOpsIssuePicker.empty.runtimeUnavailable': 'Azure DevOps 런타임 API를 사용할 수 없습니다.',
  'session.azureDevOpsIssuePicker.empty.notConnected': 'Azure DevOps에 연결되어 있지 않습니다. 설정에서 Azure DevOps 계정을 연결하세요.',
  'session.azureDevOpsIssuePicker.empty.noIssuesFound': '작업 항목을 찾지 못했습니다',
  'session.azureDevOpsIssuePicker.empty.noOpenIssuesFound': '열린 작업 항목이 없습니다',
  'session.azureDevOpsIssuePicker.loading.issues': '작업 항목 불러오는 중...',
  'session.azureDevOpsIssuePicker.loading.more': '불러오는 중...',
  'session.azureDevOpsIssuePicker.actions.openSettings': '설정 열기',
  'session.azureDevOpsIssuePicker.actions.useIssue': '작업 항목 #{number} 사용',
  'session.azureDevOpsIssuePicker.actions.openInProviderAria': 'Azure DevOps에서 열기',
  'session.azureDevOpsIssuePicker.actions.loadMore': '더 불러오기',
  'session.azureDevOpsIssuePicker.actions.sectionTitle': '작업',
  'session.azureDevOpsIssuePicker.actions.toggleWorktreeAria': '워크트리 토글',
  'session.azureDevOpsIssuePicker.actions.createInWorktree': '워크트리에서 생성',
  'session.azureDevOpsIssuePicker.actions.openRepo': '레포지토리 열기',
  'session.azureDevOpsIssuePicker.actions.refresh': '새로고침',
  ...
  'session.azureDevOpsPrPicker.error.noActiveProject': '활성 프로젝트가 없습니다',
  'session.azureDevOpsPrPicker.error.runtimeUnavailable': 'Azure DevOps 런타임 API를 사용할 수 없습니다',
  'session.azureDevOpsPrPicker.error.notConnected': 'Azure DevOps에 연결되어 있지 않습니다',
  'session.azureDevOpsPrPicker.error.prNotFound': 'Pull request를 찾을 수 없습니다',
  'session.azureDevOpsPrPicker.error.repoNotResolvable': '저장소를 확인할 수 없습니다',
  'session.azureDevOpsPrPicker.error.repoMustMatchProvider': 'origin 리모트는 Azure DevOps URL이어야 합니다',
  'session.azureDevOpsPrPicker.toast.loadMoreFailed': 'Pull request를 더 불러오지 못했습니다',
  'session.azureDevOpsPrPicker.toast.loadDetailsFailed': 'Pull request 세부 정보를 불러오지 못했습니다',
  'session.azureDevOpsPrPicker.title': 'Azure DevOps Pull Request 연결',
  'session.azureDevOpsPrPicker.description': '이 메시지에 리뷰 컨텍스트를 첨부할 pull request를 선택하세요.',
  'session.azureDevOpsPrPicker.searchPlaceholder': '제목 또는 #123으로 검색하거나 pull request URL을 붙여넣으세요',
  'session.azureDevOpsPrPicker.includeDiffAria': '첨부된 컨텍스트에 PR diff 포함',
  'session.azureDevOpsPrPicker.includeDiff': 'PR diff 포함',
  'session.azureDevOpsPrPicker.empty.noActiveProject': '선택된 활성 프로젝트가 없습니다.',
  'session.azureDevOpsPrPicker.empty.runtimeUnavailable': 'Azure DevOps 런타임 API를 사용할 수 없습니다.',
  'session.azureDevOpsPrPicker.empty.notConnected': 'Azure DevOps에 연결되어 있지 않습니다. 설정에서 Azure DevOps 계정을 연결하세요.',
  'session.azureDevOpsPrPicker.empty.noPullRequestsFound': 'Pull request를 찾을 수 없습니다',
  'session.azureDevOpsPrPicker.empty.noOpenPullRequestsFound': '열린 pull request가 없습니다',
  'session.azureDevOpsPrPicker.loading.pullRequests': 'Pull request 불러오는 중...',
  'session.azureDevOpsPrPicker.loading.more': '불러오는 중...',
  'session.azureDevOpsPrPicker.actions.openSettings': '설정 열기',
  'session.azureDevOpsPrPicker.actions.usePullRequest': 'Pull request #{number} 사용',
  'session.azureDevOpsPrPicker.actions.openInProviderAria': 'Azure DevOps에서 열기',
  'session.azureDevOpsPrPicker.actions.loadMore': '더 불러오기',
  ...
  'chat.chatInput.actions.linkIssue': '이슈 / 작업 항목 연결',
  'chat.chatInput.actions.linkPr': 'Pull request 연결',
  ...
  'memoryDebugPanel.metric.githubTotalRequests': 'PR 상태 전체 요청',
