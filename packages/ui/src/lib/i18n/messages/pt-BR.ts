...
export const dict: Record<I18nKey, string> = {
 ...settingsDict,
  ...
  "gitView.pr.actions.openOnProvider": "Abrir em {provider}",
  "gitView.pr.actions.openOnProviderAria": "Abrir PR em {provider}",
  "gitView.pr.actions.openRepo": "Abrir repositório",
  ...
  "gitView.pr.toast.prNotMerged": "Não foi feito merge da PR",
  ...
  "session.azureDevOpsIssuePicker.error.noActiveProject": "Não há nenhum projeto ativo",
  "session.azureDevOpsIssuePicker.error.runtimeUnavailable": "API de runtime do Azure DevOps não disponível",
  "session.azureDevOpsIssuePicker.error.notConnected": "Azure DevOps não está conectado",
  "session.azureDevOpsIssuePicker.error.repoNotResolvable": "Não foi possível resolver o repositório",
  "session.azureDevOpsIssuePicker.error.repoMustMatchProvider": "O remoto origin deve ser uma URL do Azure DevOps",
  "session.azureDevOpsIssuePicker.error.issueNotFound": "Work item não encontrado",
  "session.azureDevOpsIssuePicker.error.noModelSelected": "Não há nenhum modelo selecionado",
  "session.azureDevOpsIssuePicker.toast.loadMoreFailed": "Não foi possível carregar mais work items",
  "session.azureDevOpsIssuePicker.toast.loadIssueDetailsFailed": "Não foi possível carregar os detalhes do work item",
  "session.azureDevOpsIssuePicker.toast.sendContextFailed": "Não foi possível enviar o contexto do work item",
  "session.azureDevOpsIssuePicker.toast.sessionCreated": "Sessão criada a partir do work item",
  "session.azureDevOpsIssuePicker.toast.startSessionFailed": "Não foi possível iniciar a sessão",
  "session.azureDevOpsIssuePicker.title.select": "Vincular work item do Azure DevOps",
  "session.azureDevOpsIssuePicker.title.createSession": "Nova sessão de work item do Azure DevOps",
  "session.azureDevOpsIssuePicker.description.select": "Selecione um work item para vinculá-lo a esta sessão.",
  "session.azureDevOpsIssuePicker.description.createSession": "Inicie uma nova sessão com contexto oculto do work item (título/corpo/etiquetas/comentários).",
  "session.azureDevOpsIssuePicker.searchPlaceholder": "Buscar por título ou #123, ou colar a URL do work item",
  "session.azureDevOpsIssuePicker.empty.noActiveProject": "Não há nenhum projeto ativo selecionado.",
  "session.azureDevOpsIssuePicker.empty.runtimeUnavailable": "API de runtime do Azure DevOps não disponível.",
  "session.azureDevOpsIssuePicker.empty.notConnected": "Azure DevOps não está conectado. Conecte sua conta do Azure DevOps nas configurações.",
  "session.azureDevOpsIssuePicker.empty.noIssuesFound": "Nenhum work item encontrado",
  "session.azureDevOpsIssuePicker.empty.noOpenIssuesFound": "Nenhum work item aberto encontrado",
  "session.azureDevOpsIssuePicker.loading.issues": "Carregando work items...",
  "session.azureDevOpsIssuePicker.loading.more": "Carregando...",
  "session.azureDevOpsIssuePicker.actions.openSettings": "Abrir configurações",
  "session.azureDevOpsIssuePicker.actions.useIssue": "Usar work item #{number}",
  "session.azureDevOpsIssuePicker.actions.openInProviderAria": "Abrir no Azure DevOps",
  "session.azureDevOpsIssuePicker.actions.loadMore": "Carregar mais",
  "session.azureDevOpsIssuePicker.actions.sectionTitle": "Ações",
  "session.azureDevOpsIssuePicker.actions.toggleWorktreeAria": "Ativar worktree",
  "session.azureDevOpsIssuePicker.actions.createInWorktree": "Criar em worktree",
  "session.azureDevOpsIssuePicker.actions.openRepo": "Abrir repositório",
  "session.azureDevOpsIssuePicker.actions.refresh": "Atualizar",
  ...
  "session.azureDevOpsPrPicker.error.noActiveProject": "Nenhum projeto ativo",
  "session.azureDevOpsPrPicker.error.runtimeUnavailable": "API de runtime do Azure DevOps indisponível",
  "session.azureDevOpsPrPicker.error.notConnected": "Azure DevOps não conectado",
  "session.azureDevOpsPrPicker.error.prNotFound": "Pull request não encontrado",
  "session.azureDevOpsPrPicker.error.repoNotResolvable": "Repositório não resolvível",
  "session.azureDevOpsPrPicker.error.repoMustMatchProvider": "o remote origin deve ser uma URL do Azure DevOps",
  "session.azureDevOpsPrPicker.toast.loadMoreFailed": "Falha ao carregar mais pull requests",
  "session.azureDevOpsPrPicker.toast.loadDetailsFailed": "Falha ao carregar detalhes do pull request",
  "session.azureDevOpsPrPicker.title": "Vincular Pull Request do Azure DevOps",
  "session.azureDevOpsPrPicker.description": "Selecione um pull request para anexar contexto de revisão a esta mensagem.",
  "session.azureDevOpsPrPicker.searchPlaceholder": "Busque por título ou #123, ou cole URL do pull request",
  "session.azureDevOpsPrPicker.includeDiffAria": "Incluir diff do PR no contexto anexado",
  "session.azureDevOpsPrPicker.includeDiff": "Incluir diff do PR",
  "session.azureDevOpsPrPicker.empty.noActiveProject": "Nenhum projeto ativo selecionado.",
  "session.azureDevOpsPrPicker.empty.runtimeUnavailable": "API de runtime do Azure DevOps indisponível.",
  "session.azureDevOpsPrPicker.empty.notConnected": "Azure DevOps não conectado. Conecte sua conta Azure DevOps nas configurações.",
  "session.azureDevOpsPrPicker.empty.noPullRequestsFound": "Nenhum pull request encontrado",
  "session.azureDevOpsPrPicker.empty.noOpenPullRequestsFound": "Nenhum pull request aberto encontrado",
  "session.azureDevOpsPrPicker.loading.pullRequests": "Carregando pull requests...",
  "session.azureDevOpsPrPicker.loading.more": "Carregando...",
  "session.azureDevOpsPrPicker.actions.openSettings": "Abrir configurações",
  "session.azureDevOpsPrPicker.actions.usePullRequest": "Usar pull request #{number}",
  "session.azureDevOpsPrPicker.actions.openInProviderAria": "Abrir no Azure DevOps",
  "session.azureDevOpsPrPicker.actions.loadMore": "Carregar mais",
  ...
  "chat.chatInput.actions.linkIssue": "Vincular issue / work item",
  "chat.chatInput.actions.linkPr": "Vincular pull request",
  ...
  "memoryDebugPanel.metric.githubTotalRequests": "Solicitações totais de status de PR",
  ...
  "layout.mainTab.tasks": "Tasks",
  "settings.page.workspaces.title": "Workspaces",
  "settings.workspaces.description": "Gerencie workspaces de tasks e vínculo dos projetos.",
  "settings.workspaces.newPlaceholder": "Novo workspace",
  "settings.workspaces.empty": "Nenhum workspace selecionado.",
  "settings.workspaces.deleteConfirm": "Excluir workspace {name}? Os projetos voltam para o Default.",
  "settings.workspaces.action.save": "Salvar",
  "settings.workspaces.action.delete": "Excluir",
  "settings.workspaces.projects.title": "Projetos",
  "settings.workspaces.projects.empty": "Nenhum projeto configurado.",
  "settings.workspaces.toast.created": "Workspace criado",
  "settings.workspaces.toast.createFailed": "Falha ao criar workspace",
  "settings.workspaces.toast.saved": "Workspace salvo",
  "settings.workspaces.toast.saveFailed": "Falha ao salvar workspace",
  "settings.workspaces.toast.deleted": "Workspace excluído",
  "settings.workspaces.toast.deleteFailed": "Falha ao excluir workspace",
  "tasks.header.workspace": "Workspace",
  "tasks.header.projectFilter": "Filtro de projeto",
  "tasks.header.projectFilterAll": "Todos os projetos",
  "tasks.header.newTask": "Nova task",
  "tasks.header.kanban": "Kanban",
  "tasks.header.daily": "Daily",
  "tasks.workspace.new": "Novo workspace",
  "tasks.workspace.promptName": "Nome do workspace",
  "tasks.empty.noWorkspaces": "Ainda não há workspaces",
  "tasks.empty.noTasks": "Crie um workspace e sua primeira task",
  "tasks.empty.column": "Nenhuma task aqui",
  "tasks.empty.noDaily": "Nenhuma atividade de task neste dia",
  "tasks.error.load": "Falha ao carregar tasks",
  "tasks.error.retry": "Tentar novamente",
  "tasks.modal.createTitle": "Criar task",
  "tasks.modal.editTitle": "Editar task",
  "tasks.modal.deleteConfirm": "Excluir esta task?",
  "tasks.modal.field.title": "Título",
  "tasks.modal.field.project": "Projeto",
  "tasks.modal.field.status": "Status",
  "tasks.modal.field.branch": "Branch",
  "tasks.modal.field.session": "Link da sessão",
  "tasks.modal.field.tags": "Tags",
  "tasks.modal.field.tagsPlaceholder": "bug, api",
  "tasks.modal.field.content": "Conteúdo",
  "tasks.modal.field.preview": "Preview",
  "tasks.modal.contentPlaceholder": "Descreva os detalhes aqui...",
  "tasks.modal.branch.loading": "Carregando branches...",
  "tasks.modal.branch.noProject": "Escolha um projeto primeiro",
  "tasks.modal.action.delete": "Excluir",
  "tasks.modal.action.cancel": "Cancelar",
  "tasks.modal.action.save": "Salvar",
  "tasks.modal.action.create": "Criar",
  "tasks.modal.action.checkoutBranch": "Checkout",
  "tasks.modal.createMore": "Criar mais",
  "tasks.modal.action.openSession": "Abrir",
  "tasks.modal.toast.checkoutSuccess": "Checkout em {branch}",
  "tasks.modal.toast.checkoutFailed": "Falha ao fazer checkout da branch",
  "tasks.modal.timestamp.created": "Criada em {date}",
  "tasks.modal.timestamp.started": "Iniciada em {date}",
  "tasks.modal.timestamp.completed": "Concluída em {date}",
  "tasks.status.todo": "Pendente",
  "tasks.status.in_progress": "Em andamento",
  "tasks.status.done": "Concluída",
  "tasks.daily.previousDay": "Dia anterior",
  "tasks.daily.today": "Hoje",
  "tasks.daily.nextDay": "Próximo dia",
  "tasks.daily.datePicker": "Escolher dia",
  "tasks.daily.doing": "Em andamento",
  "tasks.daily.done": "Concluídas no dia",
};
