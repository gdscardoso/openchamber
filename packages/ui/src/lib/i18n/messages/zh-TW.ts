...
export const dict: Record<I18nKey, string> = {
  ...
  'session.azureDevOpsIssuePicker.error.noActiveProject': '沒有活動專案',
  'session.azureDevOpsIssuePicker.error.runtimeUnavailable': 'Azure DevOps 執行時 API 無法使用',
  'session.azureDevOpsIssuePicker.error.notConnected': 'Azure DevOps 未連線',
  'session.azureDevOpsIssuePicker.error.repoNotResolvable': '無法解析儲存庫',
  'session.azureDevOpsIssuePicker.error.repoMustMatchProvider': 'origin 遠端儲存庫必須是 Azure DevOps URL',
  'session.azureDevOpsIssuePicker.error.issueNotFound': '找不到工作項目',
  'session.azureDevOpsIssuePicker.error.noModelSelected': '未選擇模型',
  'session.azureDevOpsIssuePicker.toast.loadMoreFailed': '載入更多工作項目失敗',
  'session.azureDevOpsIssuePicker.toast.loadIssueDetailsFailed': '載入工作項目詳情失敗',
  'session.azureDevOpsIssuePicker.toast.sendContextFailed': '傳送工作項目上下文失敗',
  'session.azureDevOpsIssuePicker.toast.sessionCreated': '已從工作項目建立會話',
  'session.azureDevOpsIssuePicker.toast.startSessionFailed': '啟動會話失敗',
  'session.azureDevOpsIssuePicker.title.select': '關聯 Azure DevOps 工作項目',
  'session.azureDevOpsIssuePicker.title.createSession': '從 Azure DevOps 工作項目新增會話',
  'session.azureDevOpsIssuePicker.description.select': '選擇一個工作項目關聯到目前會話。',
  'session.azureDevOpsIssuePicker.description.createSession': '使用隱藏的工作項目上下文（標題/內文/標籤/留言）初始化新會話。',
  'session.azureDevOpsIssuePicker.searchPlaceholder': '按標題或 #123 搜尋，或貼上工作項目 URL',
  'session.azureDevOpsIssuePicker.empty.noActiveProject': '未選擇活動專案。',
  'session.azureDevOpsIssuePicker.empty.runtimeUnavailable': 'Azure DevOps 執行時 API 無法使用。',
  'session.azureDevOpsIssuePicker.empty.notConnected': 'Azure DevOps 未連線。請在設定中連接 Azure DevOps 帳號。',
  'session.azureDevOpsIssuePicker.empty.noIssuesFound': '找不到工作項目',
  'session.azureDevOpsIssuePicker.empty.noOpenIssuesFound': '沒有未關閉的工作項目',
  'session.azureDevOpsIssuePicker.loading.issues': '正在載入工作項目...',
  'session.azureDevOpsIssuePicker.loading.more': '載入中...',
  'session.azureDevOpsIssuePicker.actions.openSettings': '開啟設定',
  'session.azureDevOpsIssuePicker.actions.useIssue': '使用工作項目 #{number}',
  'session.azureDevOpsIssuePicker.actions.openInProviderAria': '在 Azure DevOps 中開啟',
  'session.azureDevOpsIssuePicker.actions.loadMore': '載入更多',
  'session.azureDevOpsIssuePicker.actions.sectionTitle': '操作',
  'session.azureDevOpsIssuePicker.actions.toggleWorktreeAria': '切換 worktree',
  'session.azureDevOpsIssuePicker.actions.createInWorktree': '在 worktree 中建立',
  'session.azureDevOpsIssuePicker.actions.openRepo': '開啟儲存庫',
  'session.azureDevOpsIssuePicker.actions.refresh': '重新整理',
  ...
  'session.azureDevOpsPrPicker.error.noActiveProject': '沒有啟用中的專案',
  'session.azureDevOpsPrPicker.error.runtimeUnavailable': 'Azure DevOps 執行時 API 無法使用',
  'session.azureDevOpsPrPicker.error.notConnected': 'Azure DevOps 未連線',
  'session.azureDevOpsPrPicker.error.prNotFound': '找不到 Pull Request',
  'session.azureDevOpsPrPicker.error.repoNotResolvable': '無法解析儲存庫',
  'session.azureDevOpsPrPicker.error.repoMustMatchProvider': 'origin 遠端儲存庫必須是 Azure DevOps URL',
  'session.azureDevOpsPrPicker.toast.loadMoreFailed': '無法載入更多 Pull Request',
  'session.azureDevOpsPrPicker.toast.loadDetailsFailed': '無法載入 Pull Request 詳細資料',
  'session.azureDevOpsPrPicker.title': '關聯 Azure DevOps Pull Request',
  'session.azureDevOpsPrPicker.description': '選擇一個 pull request，將審查內容附加到此訊息。',
  'session.azureDevOpsPrPicker.searchPlaceholder': '依標題或 #123 搜尋，或貼上 pull request URL',
  'session.azureDevOpsPrPicker.includeDiffAria': '在附加內容中包含 PR diff',
  'session.azureDevOpsPrPicker.includeDiff': '包含 PR diff',
  'session.azureDevOpsPrPicker.empty.noActiveProject': '未選取啟用中的專案。',
  'session.azureDevOpsPrPicker.empty.runtimeUnavailable': 'Azure DevOps 執行時 API 無法使用。',
  'session.azureDevOpsPrPicker.empty.notConnected': 'Azure DevOps 未連線。請在設定中連接你的 Azure DevOps 帳號。',
  'session.azureDevOpsPrPicker.empty.noPullRequestsFound': '找不到 Pull Request',
  'session.azureDevOpsPrPicker.empty.noOpenPullRequestsFound': '找不到開啟中的 Pull Request',
  'session.azureDevOpsPrPicker.loading.pullRequests': '正在載入 Pull Request...',
  'session.azureDevOpsPrPicker.loading.more': '載入中...',
  'session.azureDevOpsPrPicker.actions.openSettings': '開啟設定',
  'session.azureDevOpsPrPicker.actions.usePullRequest': '使用 Pull Request #{number}',
  'session.azureDevOpsPrPicker.actions.openInProviderAria': '在 Azure DevOps 中開啟',
  'session.azureDevOpsPrPicker.actions.loadMore': '載入更多',
  ...
  'chat.chatInput.actions.linkIssue': '關聯 Issue / Work Item',
  'chat.chatInput.actions.linkPr': '關聯 Pull Request',
  ...
  'memoryDebugPanel.metric.githubTotalRequests': 'PR 狀態請求總數',
