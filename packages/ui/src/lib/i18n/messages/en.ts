...
export const dict = {
  ...
  'session.azureDevOpsIssuePicker.error.noActiveProject': 'No active project',
  'session.azureDevOpsIssuePicker.error.runtimeUnavailable': 'Azure DevOps runtime API unavailable',
  'session.azureDevOpsIssuePicker.error.notConnected': 'Azure DevOps not connected',
  'session.azureDevOpsIssuePicker.error.repoNotResolvable': 'Repo not resolvable',
  'session.azureDevOpsIssuePicker.error.repoMustMatchProvider': 'origin remote must be an Azure DevOps URL',
  'session.azureDevOpsIssuePicker.error.issueNotFound': 'Work item not found',
  'session.azureDevOpsIssuePicker.error.noModelSelected': 'No model selected',
  'session.azureDevOpsIssuePicker.toast.loadMoreFailed': 'Failed to load more work items',
  'session.azureDevOpsIssuePicker.toast.loadIssueDetailsFailed': 'Failed to load work item details',
  'session.azureDevOpsIssuePicker.toast.sendContextFailed': 'Failed to send work item context',
  'session.azureDevOpsIssuePicker.toast.sessionCreated': 'Session created from work item',
  'session.azureDevOpsIssuePicker.toast.startSessionFailed': 'Failed to start session',
  'session.azureDevOpsIssuePicker.title.select': 'Link Azure DevOps Work Item',
  'session.azureDevOpsIssuePicker.title.createSession': 'New Session From Azure DevOps Work Item',
  'session.azureDevOpsIssuePicker.description.select': 'Select a work item to link to this session.',
  'session.azureDevOpsIssuePicker.description.createSession': 'Seeds a new session with hidden work item context (title/body/labels/comments).',
  'session.azureDevOpsIssuePicker.searchPlaceholder': 'Search by title or #123, or paste work item URL',
  'session.azureDevOpsIssuePicker.empty.noActiveProject': 'No active project selected.',
  'session.azureDevOpsIssuePicker.empty.runtimeUnavailable': 'Azure DevOps runtime API unavailable.',
  'session.azureDevOpsIssuePicker.empty.notConnected': 'Azure DevOps not connected. Connect your Azure DevOps account in settings.',
  'session.azureDevOpsIssuePicker.empty.noIssuesFound': 'No work items found',
  'session.azureDevOpsIssuePicker.empty.noOpenIssuesFound': 'No open work items found',
  'session.azureDevOpsIssuePicker.loading.issues': 'Loading work items...',
  'session.azureDevOpsIssuePicker.loading.more': 'Loading...',
  'session.azureDevOpsIssuePicker.actions.openSettings': 'Open settings',
  'session.azureDevOpsIssuePicker.actions.useIssue': 'Use work item #{number}',
  'session.azureDevOpsIssuePicker.actions.openInProviderAria': 'Open in Azure DevOps',
  'session.azureDevOpsIssuePicker.actions.loadMore': 'Load more',
  'session.azureDevOpsIssuePicker.actions.sectionTitle': 'Actions',
  'session.azureDevOpsIssuePicker.actions.toggleWorktreeAria': 'Toggle worktree',
  'session.azureDevOpsIssuePicker.actions.createInWorktree': 'Create in worktree',
  'session.azureDevOpsIssuePicker.actions.openRepo': 'Open Repo',
  'session.azureDevOpsIssuePicker.actions.refresh': 'Refresh',
  ...
  'session.azureDevOpsPrPicker.error.noActiveProject': 'No active project',
  'session.azureDevOpsPrPicker.error.runtimeUnavailable': 'Azure DevOps runtime API unavailable',
  'session.azureDevOpsPrPicker.error.notConnected': 'Azure DevOps not connected',
  'session.azureDevOpsPrPicker.error.prNotFound': 'Pull request not found',
  'session.azureDevOpsPrPicker.error.repoNotResolvable': 'Repo not resolvable',
  'session.azureDevOpsPrPicker.error.repoMustMatchProvider': 'origin remote must be an Azure DevOps URL',
  'session.azureDevOpsPrPicker.toast.loadMoreFailed': 'Failed to load more pull requests',
  'session.azureDevOpsPrPicker.toast.loadDetailsFailed': 'Failed to load pull request details',
  'session.azureDevOpsPrPicker.title': 'Link Azure DevOps Pull Request',
  'session.azureDevOpsPrPicker.description': 'Select a pull request to attach review context to this message.',
  'session.azureDevOpsPrPicker.searchPlaceholder': 'Search by title or #123, or paste pull request URL',
  'session.azureDevOpsPrPicker.includeDiffAria': 'Include PR diff in attached context',
  'session.azureDevOpsPrPicker.includeDiff': 'Include PR diff',
  'session.azureDevOpsPrPicker.empty.noActiveProject': 'No active project selected.',
  'session.azureDevOpsPrPicker.empty.runtimeUnavailable': 'Azure DevOps runtime API unavailable.',
  'session.azureDevOpsPrPicker.empty.notConnected': 'Azure DevOps not connected. Connect your Azure DevOps account in settings.',
  'session.azureDevOpsPrPicker.empty.noPullRequestsFound': 'No pull requests found',
  'session.azureDevOpsPrPicker.empty.noOpenPullRequestsFound': 'No open pull requests found',
  'session.azureDevOpsPrPicker.loading.pullRequests': 'Loading pull requests...',
  'session.azureDevOpsPrPicker.loading.more': 'Loading...',
  'session.azureDevOpsPrPicker.actions.openSettings': 'Open settings',
  'session.azureDevOpsPrPicker.actions.usePullRequest': 'Use pull request #{number}',
  'session.azureDevOpsPrPicker.actions.openInProviderAria': 'Open in Azure DevOps',
  'session.azureDevOpsPrPicker.actions.loadMore': 'Load more',
  ...
  'memoryDebugPanel.metric.githubTotalRequests': 'PR Status Total Requests',
